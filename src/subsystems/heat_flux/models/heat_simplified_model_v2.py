...
class HeatSimplifiedModel(keras.Model):
    ...
    def __init__(self, configuration_file_fwp_from_mf, configuration_file_cs_from_fwp, num_steps=30):
        self.num_steps = num_steps
        self.configuration_file_fwp_from_mf = configuration_file_fwp_from_mf
        self.configuration_file_cs_from_fwp = configuration_file_cs_from_fwp
    ...
    def _create_model(self, num_steps, include_initial_step=True):
        ...
        liquid_volume_processing = keras_gnn.layers.GraphUpdate(
            node_sets={
                'liquid': keras_gnn.layers.NodeSetUpdate(
                    next_state=LiquidVolumeLayer(layer_configuration_file=self.configuration_file_cs_from_fwp),
                    node_input_feature=['L', 'avg_f'],
        ...
        fraction_wetted_perim_processing = keras_gnn.layers.GraphUpdate(
            node_sets={
                'liquid': keras_gnn.layers.NodeSetUpdate(
                    ...
                    next_state=FractionFromMassFlowLayer(layer_configuration_file=self.configuration_file_fwp_from_mf),
                    node_input_feature={},
